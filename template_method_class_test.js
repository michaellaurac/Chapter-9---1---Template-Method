...
const { BinaryKnower, BinaryOblivious } = require("./template_method_class.js");

describe("tests run on the 'template_method_class.js' file:", () => {
  // setup
  it("verifies the test file name", () => {
    wish(fileName() === "template_method_class_test.js");
  });
  // initialisation
